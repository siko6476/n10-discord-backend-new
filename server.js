...
/*
  ...
  Every call creates a completely
  new Access Key.

  We DO NOT search for an old key.
*/
    ...
    try {
      ...
      if (keyRow.used) {
        ...
        return sendError(
          res,
          400,
          "هذا المفتاح مستعمل من قبل. ارجع إلى Discord واضغط تسجيل الدخول من جديد للحصول على مفتاح جديد."
        );
      }
    ...
    const server =
      app.listen(
        ...
        () => {
          ...
          console.log(
            "🔑 NEW Access Key per new Discord OAuth: ON"
          );
